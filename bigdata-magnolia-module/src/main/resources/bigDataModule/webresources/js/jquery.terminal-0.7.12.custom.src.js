    ...
    */
    ...
    $.fn.cmd = function(options) {
        ...
        function paste() {
            ...
            self.oneTime(100, function() { /*modified by Magnolia see MGNLGROOVY-104*/
            ...
            if (!self.paused()) {
                ...
                if (e.which === 68 && e.ctrlKey) { // CTRL+D
                    ...
                    interpreters.top().completion(self, string, function(commands) {
                        ...
                        //Magnolia: basic code completion
                        var code_completion = false;
                        if(command.lastIndexOf(".") != -1) {
                            reg = new RegExp('^' + $.terminal.escape_regex(string.substring(string.lastIndexOf('.')+1)));
