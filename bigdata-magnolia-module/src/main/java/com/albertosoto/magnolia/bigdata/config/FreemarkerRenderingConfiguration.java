...
/**
 * Configuration class for using Freemarker views. Import this class instead of
 * {@link SiteAwareFreemarkerRenderingConfiguration} if you're not interested in merging in configuration from the site
 * definition template prototype.
 */
@Configuration
public class FreemarkerRenderingConfiguration {
     ...
     */
    @Bean
    public FreemarkerTemplateViewRenderer freemarkerTemplateViewRenderer() {
